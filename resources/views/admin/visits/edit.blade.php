    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="card">
        ...
        <input type="hidden" name="_method" value="PUT">
          ...
          <div class="form-group">
            <label for ="date_and_time">date and time</labeltime>
            <input type="text" class="form-control" id="date_and_time" name="date_and_time" value="{{old('date_and_time', $visit->date_and_time)}}"/>
          </div>
